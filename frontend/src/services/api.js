...
export const consumerAPI = {
  ...
  verifyEmailOtp: (email, otp) => consumerAxios.post('/consumer/verify-email-otp', { email, otp }),
  resendEmailOtp: (email) => consumerAxios.post('/consumer/resend-email-otp', { email }),
