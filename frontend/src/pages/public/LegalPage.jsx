...
const PAGES = {
  terms: {
    ...
    updated: '24 May 2026',
    intro: 'These terms explain how customers and businesses use Glam Genie for discovery, bookings, messages, payments, and support.',
    sections: [
      ['Using Glam Genie', 'You must provide accurate account, booking, business, and contact information. Do not misuse the platform, impersonate another person, upload harmful content, or interfere with the service.'],
      ...
      ['Customer Responsibilities', 'Customers are responsible for attending appointments, giving correct contact details, reading service information, and contacting the business or Glam Genie support when something goes wrong.'],
      ['Payments', 'Where online payments are available, payments are processed through Stripe. Glam Genie may display booking and payment status, support dispute handling, and help with refunds where appropriate.'],
      ['Availability', 'We work to keep the service reliable, but Glam Genie may be unavailable during maintenance, outages, provider downtime, or technical incidents.'],
    ],
  },
  privacy: {
    title: 'Privacy Policy',
    updated: '24 May 2026',
    intro: 'This policy explains the information Glam Genie collects and how it is used to run bookings, accounts, payments, support, and safety features.',
    sections: [
      ...
      ['Your Rights', 'You can ask to access, correct, export, or delete your data by contacting Glam Genie support. Some records may need to be kept where required by law or legitimate business reasons.'],
    ],
  },
  refunds: {
    title: 'Refunds, Cancellations and Disputes',
    updated: '24 May 2026',
    intro: 'This page explains how cancellations, refunds, and service disputes should be handled on Glam Genie.',
    sections: [
      ...
      ['Business Review', 'Businesses may be contacted for evidence, notes, or a response. Glam Genie support can reject unsupported claims or help issue refunds where appropriate.'],
  ...
  cookies: {
    title: 'Cookie Policy',
    updated: '24 May 2026',
    intro: 'This policy explains how Glam Genie uses cookies and browser storage to keep the app secure, reliable, and useful.',
    sections: [
      ...
      ['Third-Party Services', 'Glam Genie may use providers such as Stripe for payments, Firebase for authentication, Resend for email, and hosting or security providers. These services may set their own necessary cookies or storage when their features are used.'],
      ...
      ['No Sale of Data', 'Glam Genie does not sell personal data. Any analytics should be used to operate, secure, and improve the platform.'],
    ],
  },
};
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <img src={LOGO_BLUE_H} alt="Glam Genie" className="h-8 w-auto object-contain dark:brightness-0 dark:invert" />
        </div>
        ...
        <section className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 sm:p-8 shadow-sm">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-300 text-xs font-bold mb-4">
            <ShieldCheck className="w-3.5 h-3.5" /> Glam Genie Policy
          </div>
