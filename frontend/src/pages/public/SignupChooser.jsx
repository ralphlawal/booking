...
export default function SignupChooser() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-700 via-primary-800 to-slate-900 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md animate-slide-up text-center">
        <h1 className="text-3xl font-bold text-white mb-2">Join BookAm</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link
            to="/admin/register"
            className="group flex flex-col items-center text-center bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 rounded-2xl p-6 transition-all duration-200"
          >
            <div className="w-16 h-16 rounded-2xl bg-primary-500 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <BusinessIcon />
            </div>
          ...
          <Link
            ...
            className="group flex flex-col items-center text-center bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 rounded-2xl p-6 transition-all duration-200"
          >
            <div className="w-16 h-16 rounded-2xl bg-emerald-500 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <CustomerIcon />
            </div>
