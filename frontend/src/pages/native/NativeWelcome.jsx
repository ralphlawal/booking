...
export default function NativeWelcome() {
  return (
    <main className="min-h-[100dvh] overflow-hidden bg-[#09081d] text-white flex flex-col px-6" style={{ paddingTop: 'max(2rem, env(safe-area-inset-top, 0px))', paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom, 0px))' }}>
